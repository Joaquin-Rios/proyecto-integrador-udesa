window.addEventListener('load', function(){
    ...
    .then(function(generos){
        ...
        generos.results.forEach(pelicula => {
                ...
                articulo.innerHTML += ` <a href= "detallePelicula.html?foto=${pelicula.poster_path}&title=${pelicula.title}"><img src= "https://image.tmdb.org/t/p/w500${pelicula.poster_path}" alt='${pelicula.title}'/></a>
                <div>
